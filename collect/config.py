...
# 180s gives grounded GPT-5.5 / search calls generous headroom; a stale socket
# still errors (vs hanging forever), timeouts are retried, and a query that times
# out MAX_TIMEOUT_RETRIES times in a row is skipped (captured=false).
REQUEST_TIMEOUT = 180
